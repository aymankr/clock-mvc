...
public class ClockScenariosTest {
	...
	//annotation "@Before" : la m�thode initial() est executee avant les tests
	@Before
		public void initial() {
	...
	// test la methode addHour(x) avec x positif
	@Test
	...
	// test la methode addHour(x) avec x  negatif
	@Test
	...
	// test la methode addMinute(x) avec x positif
	@Test
	...
	// test la m�thode addMinute(x) avec x negatif
	@Test
	...
	// test la m�thode addSecond(x) avec x positif
	@Test
	...
	// test la methode addSecond(x) avec x negatif
	@Test
